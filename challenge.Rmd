...
Bienvenue sur la page du challenge d'[Apprentissage automatique](https://sites.google.com/site/adrientodeschini/teaching/ml2014) du Master 2 MIMSE !


```{r echo=FALSE}
deadline = as.POSIXct("2015-01-07 23:59:59")
time_left = deadline-Sys.time()
...
| ![](figures/glyphicons_135_inbox_out.png) \ **`r stats$n_contrib`** | ![](figures/glyphicons_043_group.png) \ **`r stats$n_team`** | ![](figures/glyphicons_045_calendar.png) \ **`r paste("J -", floor(time_left))`** |
|:-------------:|:-------------:|:-------------:|
| contributions | participants | en cours |
...
Les icônes proviennent du site [GLYPHICONS.com]() et sont distribuées sous la licence
