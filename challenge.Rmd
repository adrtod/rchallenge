...
```{r echo=FALSE}
deadline_old = as.POSIXct("2014-12-05 23:59:59")
...
- **Date limite des contributions** : ~~`r format(deadline_old, "%A %d %b %Y %H:%M", usetz=TRUE)`~~  `r format(deadline, "%A %d %b %Y %H:%M", usetz=TRUE)`
