...
if (exists("best", mode = "list"))
  print_leaderboard(best, "error", test_name=test_or_quiz, 
                    caption="Error rate", col.names=colnames)
```

```{r, echo = FALSE , results='asis'}
if (exists("best", mode = "list"))
  print_leaderboard(best, "cost", test_name=test_or_quiz, 
                    caption="Average cost", col.names=colnames)
```
...
# Submissions history
```{r, echo=FALSE, fig.cap="Error rate", fig.height=5, fig.width=9}
# color palette
...
```{r, echo=FALSE, fig.cap="Average cost", fig.height=5, fig.width=9}
par(mar = c(5,4,4,7) + 0.1)
plot_history(history, "cost", test_name=test_or_quiz, baseline=baseline)
```

```{r, echo=FALSE, fig.cap="Activity", fig.height=5, fig.width=9}
par(mar = c(5,4,4,7) + 0.1)
